...
import 'package:imc_calc_flutter/core/shared/imc_preferences.dart';
import 'package:imc_calc_flutter/models/imc.dart';
import 'package:imc_calc_flutter/core/repository/imc_repository.dart';
import 'package:imc_calc_flutter/core/services/imc_calc_service.dart';
...
class _IMCCalcState extends State<IMCCalc> {
  ...
  var imcPreferences = IMCPreferences();
  ...
  void getAltura() async {
    var altura = await imcPreferences.getAltura();
    if (altura > 0) {
  ...
  void setAltura(double altura) async {
    imcPreferences.setAltura(altura);
  }
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext ctx, int i) {
                  ...
                  return ListTile(
                    leading: Text(
                        "IMC ${imcService.calculateIMC(imc.peso, imc.altura).toStringAsFixed(2)}"),
                    title: Text(
                        "Altura ${imc.altura.toStringAsFixed(2)} e Peso ${imc.peso.toStringAsFixed(2)}"),
